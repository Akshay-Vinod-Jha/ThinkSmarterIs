...
const sliderArray = [{
    ...
    description:'These websites offer AI tools tailored for student use, enhancing the study experience.'
},{
    ...
    description:'Efficiently accomplishes complex tasks and expeditiously delivers solutions, thereby conserving valuable student time.'
},{
    src:noexternalvisitImage,
    title:'No External Visits',
    description:'Eliminates the need for students to visit multiple websites to accomplish diverse tasks.'
}];
...
const SliderCantainer = () => {
    ...
    // }
    return <diV className={classes.whychooseusCantainer}>
        <h1 className={classes.whychooseus}>
                Why Choose Us
            </h1>
        <div className={classes.slideCantainer} >
            
{sliderArray.map((slide,ind)=>{
    return <Slide key={`slider${ind}`} src={slide.src} title={slide.title} description={slide.description}/>
})}
    </div>
    </diV>
}
